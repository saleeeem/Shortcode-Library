...
const allPosts = wp.apiFetch({
  path: "/shortcode-directory/v1/shortcodes"
}).then(id => {
  postSelections.push({
...
registerBlockType('shortcode-directory/shortcode-block-list', {
  ...
  title: __('ShortCode Library'),
  // Block title.
  icon: 'shortcode',
  // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
  category: 'common',
  // Block category — Group blocks together based on common traits E.g. common, formatting, layout widgets, embed.
  keywords: [__('shortcode'), __('short'), __('library')],
  attributes: {
    // title: {
    // 	type: 'string',
    // },
  ...
  edit: props => {
    ...
    return [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      class: "panel"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, "Select Shortcode: "), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(SelectControl, {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkshortcode_directory"] = self["webpackChunkshortcode_directory"] || [];
